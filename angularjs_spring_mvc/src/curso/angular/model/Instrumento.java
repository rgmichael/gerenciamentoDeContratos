...
/**
 * Modelo que representa a tabela de Instrumento 
 * @author Francisco
 *
 */
@Entity
public class Instrumento implements Serializable {
	...
	public String getCertificadoCalibracao() {
		return certificadoCalibracao;
	}

	public void setCertificadoCalibracao(String certificadoCalibracao) {
		this.certificadoCalibracao = certificadoCalibracao;
	}
