				...
				//	allDay: false,
					...
					eventClick: function(event) {
						 ...
						 $(this).css('border-color', 'red');
							...
							$('#editar #dtCriacao').val(event.data_inclusao);
							$('#editar #usuCriacao').val(event.usuario_inclusao);
							
							//alert($('#editar #dtCriacao').val());
							
							if (event.data_inclusao != null){
								$('#editar #criado').text(event.data_inclusao + " - " +event.usuario_inclusao );
							}
							else{
								$('#editar #criado').text("-");
							}
							
							if (event.data_alteracao != null){
								$('#editar #alterado').text(event.data_alteracao + " - " +event.usuario_alteracao);
							}else{
								$('#editar #alterado').text("-");
							}
						 ...
						 /*   $('#cadastrar #start').datepicker({
							...
							*/
							   ...
							   $('#editar #end').val(moment(event.end).format('YYYY-MM-DD'));
							   //retirado datepicker erro nao abre mais - mike
							   /*
				...
				//		alert(moment(end).format('DD/MM/YYYY HH:mm'));
					 ...
					 /*   $('#cadastrar #start').datepicker({
						...
						*/
						   ...
						   $('#cadastrar #end').val(moment(start).format('YYYY-MM-DD'));
						   //retirado datepicker erro nao abre mais - mike
...
if(validarCampos()){	
		...
		//var fim = $('#cadastrar #end').val().split('-').reverse().join('/');
		...
		event2.end_time = fim+' '+$('#cadastrar #endHorario').val();
...
function enviarAlteracao() {
	...
	event2.end_time = fim+' '+formulario.endHorario.value ;
	
//	alert("alterar end="+event2.end_time);
   ...
   event2.data_inclusao = formulario.dtCriacao.value;
   event2.usuario_inclusao = formulario.usuCriacao.value;
...
var fim = $('#editar #end').val().split('-').reverse().join('/');
...
function validarCampos(){
	...
	//alert("inicio= " + $('#cadastrar #start').val());
	
	//alert("fim= " + $('#cadastrar #end').val());
	
	var brDate = $('#cadastrar #end').val().split('-').reverse().join('/');
	
	//alert("brDate= " + brDate);
	
    if ($('#cadastrar #start').val() != "" && brDate != "" ) {

    	var dtInicial = new Date($('#cadastrar #start').val() +' '+ $('#cadastrar #startHorario').val());
	 	var dtFinal = new Date(brDate +' '+ $('#cadastrar #endHorario').val());
